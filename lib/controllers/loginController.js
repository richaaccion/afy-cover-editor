...
loginController.prototype.getLogin = function(req, res) {
	...
	if(!req.query.username) {
		responseObj = this.fastify.responseFormatter.createResponse(false, "invalid_credentials");
		...
		if (req.query.username === "ric" && req.query.password === "jos") {
			...
			responseObj = this.fastify.responseFormatter.createResponse(false, "forbidden");
		}
	}
